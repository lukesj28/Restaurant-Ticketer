...
public class TicketTest {
    ...
    public void testAddOrdersAndCalculatePrice() {
        ...
        order1.addItem(OrderItem.forItem(null, "A", null, null, 1000, 0));

        Order order2 = new Order(1000);
        order2.addItem(OrderItem.forItem(null, "B", null, null, 500, 0));
    ...
    public void testDifferentTaxRates() {
        ...
        orderZeroTax.addItem(OrderItem.forItem(null, "Item", null, null, 10000, 0));
        ticket.addOrder(orderZeroTax);
        assertEquals(10000, ticket.getTotal());
        assertEquals(0, ticket.getTax());

        Order orderHighTax = new Order(2500);
        orderHighTax.addItem(OrderItem.forItem(null, "Item", null, null, 10000, 0));
    ...
    public void testRemoveOrder() {
        ...
        order.addItem(OrderItem.forItem(null, "Item", null, null, 10000, 0));
