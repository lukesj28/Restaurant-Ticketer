...
public class OrderTest {
    ...
    public void testAddItemsAndCalculateTotal() {
        Order order = new Order();
        OrderItem item1 = new OrderItem("Burger", null, 1000, 0, null);
        OrderItem item2 = new OrderItem("Fries", "Large", 550, 0, null);
    ...
    public void testTaxCalculation() {
        ...
        OrderItem item = new OrderItem("Burger", null, 1000, 0, null);
