...
public class AnalysisServiceTest {
    ...
    public void testGenerateReportBasicAggregation() throws IOException {
        ...
        o1.addItem(new OrderItem("test-category", "HistoryItem", null, null, 1000, 0, 0, null));
        t1.addOrder(o1);
        ...
        o2a.addItem(new OrderItem("test-category", "MemoryItem1", null, null, 1000, 0, 0, null));
        t2.addOrder(o2a);

        Order o2b = new Order(0);
        o2b.addItem(new OrderItem("test-category", "MemoryItem2", null, null, 1000, 0, 0, null));
        t2.addOrder(o2b);
    ...
    public void testAverageRounding() throws IOException {
        ...
        Ticket t1 = new Ticket(1);
        Order o1 = new Order(0);
        o1.addItem(new OrderItem("test-category", "Item1", "none", null, 100, 0, 0, null));
        t1.addOrder(o1);

        Ticket t2 = new Ticket(2);
        Order o2 = new Order(0);
        o2.addItem(new OrderItem("test-category", "Item2", "none", null, 101, 0, 0, null));
        t2.addOrder(o2);
    ...
    public void testRankings() throws IOException {
        Ticket t1 = new Ticket(1);
        Order o1 = new Order(0);
        o1.addItem(new OrderItem("test-category", "Burger", "Fries", null, 1000, 200, 0, null));
        o1.addItem(new OrderItem("test-category", "Burger", "Salad", null, 1000, 200, 0, null));
        o1.addItem(new OrderItem("test-category", "Soda", "none", null, 200, 0, 0, null));
        t1.addOrder(o1);
    ...
    public void testDailyRanking() {
        ...
        t1.setCreatedAt(Instant.parse("2023-01-01T10:00:00Z"));
        Order o1 = new Order(0);
        o1.addItem(new OrderItem("test-category", "Item1", "none", null, 1000, 0, 0, null));
        t1.addOrder(o1);

        Ticket t2 = new Ticket(2);
        t2.setCreatedAt(Instant.parse("2023-01-02T10:00:00Z"));
        Order o2 = new Order(0);
        o2.addItem(new OrderItem("test-category", "Item1", "none", null, 2000, 0, 0, null));
        t2.addOrder(o2);

        Ticket t3 = new Ticket(3);
        t3.setCreatedAt(Instant.parse("2023-01-03T10:00:00Z"));
        Order o3 = new Order(0);
        o3.addItem(new OrderItem("test-category", "Item1", "none", null, 500, 0, 0, null));
        t3.addOrder(o3);
