...
public class AnalysisServiceTest {
    ...
    public void testGenerateReportBasicAggregation() throws IOException {
        ...
        o1.addItem(OrderItem.forItem(null, "HistoryItem", null, null, 1000, 0));
        t1.addOrder(o1);
        ...
        o2a.addItem(OrderItem.forItem(null, "MemoryItem1", null, null, 1000, 0));
        t2.addOrder(o2a);

        Order o2b = new Order(0);
        o2b.addItem(OrderItem.forItem(null, "MemoryItem2", null, null, 1000, 0));
        t2.addOrder(o2b);
    ...
    public void testAverageRounding() throws IOException {
        ...
        Ticket t1 = new Ticket(1);
        Order o1 = new Order(0);
        o1.addItem(OrderItem.forItem(null, "Item1", null, null, 100, 0));
        t1.addOrder(o1);

        Ticket t2 = new Ticket(2);
        Order o2 = new Order(0);
        o2.addItem(OrderItem.forItem(null, "Item2", null, null, 101, 0));
        t2.addOrder(o2);
    ...
    public void testRankings() throws IOException {
        Ticket t1 = new Ticket(1);
        Order o1 = new Order(0);
        o1.addItem(OrderItem.forItem(null, "Burger", null, "Fries", 1000, 200));
        o1.addItem(OrderItem.forItem(null, "Burger", null, "Salad", 1000, 200));
        o1.addItem(OrderItem.forItem(null, "Soda", null, null, 200, 0));
        t1.addOrder(o1);
    ...
    public void testDailyRanking() {
        ...
        t1.setCreatedAt(Instant.parse("2023-01-01T10:00:00Z"));
        Order o1 = new Order(0);
        o1.addItem(OrderItem.forItem(null, "Item1", null, null, 1000, 0));
        t1.addOrder(o1);

        Ticket t2 = new Ticket(2);
        t2.setCreatedAt(Instant.parse("2023-01-02T10:00:00Z"));
        Order o2 = new Order(0);
        o2.addItem(OrderItem.forItem(null, "Item1", null, null, 2000, 0));
        t2.addOrder(o2);

        Ticket t3 = new Ticket(3);
        t3.setCreatedAt(Instant.parse("2023-01-03T10:00:00Z"));
        Order o3 = new Order(0);
        o3.addItem(OrderItem.forItem(null, "Item1", null, null, 500, 0));
        t3.addOrder(o3);
